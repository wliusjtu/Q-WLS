...
void getLaplacian(double **vecGuide, double *a, double **b, double lambda, double *rangeLUT, int sysLen);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    //////// SG_WLS parameters  ///////////////
    double lambda = mxGetScalar(prhs[2]); // lambda of the Q-WLS
    ...
    double **vecGuide = memAllocDouble2(maxSysLen, chaNumGuide + 2);  // RGB pixel values + x/y coordinates for spatial weight computation
...
void getLaplacian(double **vecGuide, double *a, double **b, double lambda, double *rangeLUT, int sysLen)
{
    double *ptr_guide_cur, *ptr_guide_nei, *ptr_a, *ptr_b;
